...
| [**Anomaly Correlation Notifier**](./projects/anomaly-correlation-notifier/) | `Data Science` | Node.js / TypeScript | Real-time alerts for correlated anomalies via WebSocket and email. |
| [**Anomaly Correlation Orchestrator**](./projects/anomaly-correlation-orchestrator/) | `Full-Stack / Backend` | Node.js / TypeScript | Orchestrates cross‑project anomaly analysis with async queues and caching. |
